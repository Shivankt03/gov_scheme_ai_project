    ...
    <div className="flex min-h-screen bg-[#07090F] text-white font-sans">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#12141D] flex-col justify-between p-10 relative overflow-hidden border-r border-white/5 shadow-[inset_-10px_0_30px_rgba(0,0,0,0.5)]">
        ...
        <div className="max-w-[480px] mx-auto text-center flex flex-col items-center justify-center -mt-16">
          {/* 5 Stars */}
          <div className="flex gap-1.5 text-[#fbbf24] mb-8 mt-4">
            {[1, 2, 3, 4, 5].map((star) => (
          ...
          <p className="text-3xl leading-snug font-medium mb-12 text-gray-100/90 tracking-tight">
            "JanSuvidha has saved us thousands of hours of work. We're able to find and apply for schemes much faster."
          </p>
          
          <div className="flex flex-col items-center">
            {/* Avatar */}
            <div className="relative mb-3">
              <div className="absolute bottom-0 right-0 w-4 h-4 bg-[#34A853] rounded-full border-[3px] border-[#12141D] shadow flex items-center justify-center">
            ...
            <p className="font-bold text-[15px] text-gray-100">Himesh Manek</p>
            <p className="text-sm text-gray-400 mt-0.5 font-medium"> Gram Panchayat, Bhavnagar</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative overflow-y-auto">
        ...
        <div className="w-full max-w-[380px] my-auto mt-8 lg:my-auto">
          {/* Mobile Logo */}
          ...
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2.5 text-white tracking-tight">Sign up</h1>
            <p className="text-gray-400 text-[15px]">Start your journey to government support.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1.5 tracking-wide" htmlFor="name">
                Name
              </label>
              <input
                id="name"
